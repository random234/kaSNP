...
kasnp: kasnp.o readinput.o gff3vis.o mutscan.o mutgene.o resultset.o vcfoutput.o
	$(LD) $(LDFLAGS) $(GT_LDFLAGS) $< -lm -lgenometools -lcairo -o $@ readinput.o gff3vis.o mutscan.o mutgene.o resultset.o vcfoutput.o
